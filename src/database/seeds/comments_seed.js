...
exports.seed = async function(knex) {
  ...
  await knex('Comments').insert([
    ...
    { UserName: 'Rógers', PostId: 3, Comment: 'Testes Mensagem Comentário Rógers - Post3' },
    { UserName: 'Rógers', PostId: 2, Comment: 'Testes Mensagem Comentário Rógers - Post2' },
    { UserName: 'Rógers', PostId: 1, Comment: 'Testes Mensagem Comentário Rógers - Post1' }
  ]);
};
